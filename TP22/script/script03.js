...
document.querySelector("#colorRojo").addEventListener("click",(e) => {
    document.getElementById("color").style.backgroundColor ="red";
});
document.querySelector("#colorVerde").addEventListener("click",(e) => {
    document.getElementById("color").style.backgroundColor ="green";
});
document.querySelector("#textoReducir").addEventListener("click",(e) => {
    document.getElementById("texto").style.fontSize ="10px";
});
document.querySelector("#textoAgrandar").addEventListener("click",(e) => {
